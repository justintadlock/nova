...
![A screenshot of the Modula Gallery plugin on the front end displaying several 'magical' images.](/user/media/2019/02/modula-banner.jpg){.alignwide}
...
![Edit screen in the WordPress admin for the Modula Gallery plugin.](/user/media/2019/02/modula-gallery-edit.jpg){.alignright}
...
![Screenshot of the Modula Gallery plugin's front end output. The images show forest scenes.](/user/media/2019/02/modula-forest-gallery.jpg){.alignwide}
...
![Screenshot of the edit image popup with the filters option.](/user/media/2019/02/modula-filters.jpg){.alignwide}
...
![Video gallery front end output of the Modula Video add-on.](/user/media/2019/02/modula-video-gallery.jpg){.alignwide}
