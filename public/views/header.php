	...
	<header class="app-header sticky md:static z-40 top-0 flex flex-wrap items-center justify-between w-full h-auto bg-white border-blue-200 border-t-2">
		...
		<div class="app-header__branding overflow-hidden flex justify-start items-center md:flex-grow-0 max-w-full h-16 px-8 text-center">
			<<?= e( $title_tag ) ?> class="app-header__title m-0 font-secondary font-400 text-3xl leading-none">
				<a class="app-header__title-link text-gray-700 no-underline hover:underline border-0" href="<?= e( uri() ) ?>">Justin Tadlock</a>
			</<?= e( $title_tag ) ?>>
		</div>
		...
		<nav class="menu menu--primary hidden md:block w-full md:h-20 flex-grow md:flex md:items-center md:justify-end md:w-auto ml-auto md:pr-2 text-lg leading-none border-t border-b md:border-0 border-gray-200">
			<ul class="menu__items list-none md:h-full m-0 p-0">
				...
				<li class="menu__item md:inline"><a class="menu__link block md:inline-block px-8 py-3 md:p-6 md:h-full text-gray-700 border-0 no-underline hover:underline" href="<?= e( uri() ) ?>/archives">Archives</a></li>
				<li class="menu__item md:inline"><a class="menu__link block md:inline-block px-8 py-3 md:p-6 md:h-full text-gray-700 border-0 no-underline hover:underline" href="<?= e( uri() ) ?>/contact">Contact</a></li>
				<li class="menu__item md:inline"><a class="menu__link block md:inline-block px-8 py-3 md:p-6 md:h-full text-gray-700 border-0 no-underline hover:underline" href="<?= e( uri() ) ?>/writing">Writing</a></li>
				<li class="menu__item md:inline"><a class="menu__link block md:inline-block px-8 py-3 md:p-6 md:h-full text-gray-700 border-0 no-underline hover:underline" href="http://feeds.feedburner.com/JustinTadlock">Subscribe</a></li>
			</ul>
		</nav>
